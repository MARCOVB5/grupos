...
\begin{frame}
\frametitle{Importância dos Grupos Quocientes}

\begin{itemize}
\item \textbf{Estrutura fundamental:} Permite "simplificar" grupos removendo subgrupos normais
\pause
\item \textbf{Classificação:} Essencial para classificar grupos via séries de composição
\pause
\item \textbf{Homomorfismos:} Conecta-se diretamente com o teorema fundamental dos homomorfismos
\pause
\item \textbf{Aplicações:} Base para teoria de Galois, geometria algébrica, topologia algébrica
\end{itemize}
