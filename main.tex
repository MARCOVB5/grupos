...
Pela \hyperlink{prop165}{\textbf{Proposição 1.6.5}}, sabemos que o homomorfismo inverso, $\varphi^{-1}$, existe e é um isomorfismo. Logo, concluímos que $\varphi^{-1} \in \operatorname{Aut}(G)$.
...
\textit{Onde $D_4$ é o Grupo Diedral $D_4$. Note que de fato a cadeia de normalidade é verificada, uma vez que:}

\begin{itemize}
	\item \textit{Primeiramente, note que $K \leq H \leq G$, evidentemente};
	\item \textit{$H$ é abeliano, e, portanto, $K\trianglelefteq H$;}
...
Como $M \overset{def}{=} m_1\ldots m_n$, temos, evidentemente, que $\mathbb{Z}/m_i\mathbb{Z} \leq \mathbb{Z}/M\mathbb{Z}, \; \forall i\in\llbracket 1,n\rrbracket$.

Note que, como $\mathbb{Z}/m\mathbb{Z}$ é abeliano $\forall m\in\mathbb{Z}_{+}^{*}$, então $\mathbb{Z}/m_i\mathbb{Z} \trianglelefteq \mathbb{Z}/M\mathbb{Z}, \; \forall i \in \llbracket 1, n\rrbracket$.

Temos também que, pelo fato dos elementos de $\mathbb{Z}/m\mathbb{Z}$ serem classes laterais, $\mathbb{Z}/m_i\mathbb{Z} \cap \mathbb{Z}/m_j\mathbb{Z} = \{\bar{1}\}, \; \forall i,j \in \llbracket 1, n \rrbracket$ e $i\neq j$.

Pelo mesmo motivo (elementos sendo classes laterais), temos, utilizando notação aditiva:

\[
\sum_{i=1}^{n} \mathbb{Z}/m_i\mathbb{Z} = \mathbb{Z}/M\mathbb{Z}
\]

Temos, portanto, que:

\[
\mathbb{Z}/M\mathbb{Z} = \bigodot_{i=1}^{n} \mathbb{Z}/m_i\mathbb{Z}
\] 

Pelo \hyperlink{teo171}{\textbf{Teorema 1.7.1}}, temos diretamente que:
