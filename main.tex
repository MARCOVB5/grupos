...
Sabemos que $\operatorname{Inn}(G) \subseteq \operatorname{Aut}(G)$.

Mostremos, primeiramente, que para $y_1, y_2 \in \operatorname{Inn}(G), \; y_1y_{2}^{-1}\in \operatorname{Inn}(G)$.
...
Provemos agora que para $(x, a)\in \operatorname{Inn}(G) \times \operatorname{Aut}(G), \; axa^{-1} \in \operatorname{Inn}(G)$.
