...
\begin{proposition}
Sejam $H$ e $K$ dois subgrupos de $G$. Se $H$ ou $K$ for normal em $G$, então $HK \leq G$.
\end{proposition}
...
Para mostrarmos que $HK \leq G$ é suficiente mostrar que a operação de $HK$ é uma lei de composição interna e que para todo elemento de $HK$, existe elemento inverso.
