...
\begin{enumerate}
	...
	\item O \textbf{Teorema de Lagrange} também pode ser aplicado no caso em que $G$ é infinito.
\end{enumerate}
...
Caso $\vert G \vert < \infty$, podemos utilizar o $\hyperlink{lagrange}{\textbf{Teorema de Lagrange}}$:
