...
\[
\bar{x} = \bar{y} \iff \bar{x}\bar{y}^{-1} \in \ker\varphi \iff \varphi(\bar{x}\bar{y}^{-1}) = e_{\mathcal{G}} \iff
\]

\[
\iff \varphi(\bar{x})\varphi(\bar{y})^{-1} = e_{\mathcal{G}} \iff \varphi(\bar{x}) = \varphi(\bar{y}) \iff \psi(\bar{x}) = \psi(\bar{y})
\]
...
\[
\psi(\bar{x}\bar{y}) = \psi(\bar{xy}) = \varphi(xy) = \varphi(x)\varphi(y) = \psi(\bar{x})\psi(\bar{y})
\]
