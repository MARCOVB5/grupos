...
\textit{Note que o conjunto $AB$ não necessariamente é um grupo mesmo que $A$ e $B$ sejam.}
...
\[
\varphi(x\cdot y) = \varphi(x) * \varphi(y) = e_\mathcal{G} * e_\mathcal{G} = e_\mathcal{G}; 
\]

\[
\varphi(x^{-1}) = \varphi(x)^{-1} = e_{\mathcal{G}}^{-1} = e_\mathcal{G}.
\]

Deduzimos que $\ker \varphi \leq G$, mostremos, por fim, que $\ker \varphi \trianglelefteq G$:

Sejam $g, x \in G\times \ker \varphi$, mostremos que $gkg^{-1} \in \ker \varphi$.
...
Sabemos por hipótese que $\varphi$ é injetiva, logo, supondo que $\varphi(x) = e_{\mathcal{G}}$ e que $\varphi(x) = \varphi(y)$, para $x,y \in G$, temos:

\[
\varphi(x) = \varphi(y) \implies \varphi(x)\varphi(y)^{-1} = e_{\mathcal{G}} \implies \varphi(x)\varphi(y^{-1}) = e_{\mathcal{G}} \implies \varphi(xy^{-1}) = e_{\mathcal{G}}
\]

Logo deduzimos que $xy^{-1} \in \ker \varphi$. 

Ora, mas sabemos pela hipótese de que $\varphi$ é injetiva que $x = y$.
...
\begin{proposition}
\color{red}
Sejam $G$ e $\mathcal{G}$ tal que $\varphi : G \to \mathcal{G}$ é um isomorfismo de grupos. 

Logo, $\varphi^{-1}$ é um homomorfismo de grupos.
\end{proposition}
