...
Seja $M_i \overset{def}{=} \frac{M}{m_i}, \; \forall i\in \llbracket 1, n\rrbracket$. Note que $\bar{M_i} \in \mathbb{Z}/M\mathbb{Z}$, uma vez que $M_i \in \llbracket 1, M-1\rrbracket$.

Note também que, evidentemente, temos $\mathcal{O}(M_i) = m_i$, uma vez que $m_iM_i = M$.

A partir da \hyperlink{prop165}{\textbf{Proposição 1.6.5}} temos portanto $\mathbb{Z}/m_i\mathbb{Z} \cong \langle M_i \rangle$. 

Mostremos que $\mathbb{Z}/M\mathbb{Z} = \bigodot_{i=1}^{n} \langle M_i \rangle$.

É evidente que $\langle M_i \rangle \leq \mathbb{Z}/M\mathbb{Z}$, uma vez que, por definição, ele é um subgrupo gerado. Além disso, por estar munido da soma usual dos inteiros, também é um grupo abeliano. Temos diretamente que $\langle M_i \rangle \trianglelefteq \mathbb{Z}/M\mathbb{Z}$.
