...
\[
\text{Card}(xH) = \vert H\vert, \; \forall x \in G.
\]
...
Mostremos a implicação $(i) \implies (ii)$:

Se a operação '$\square$' está bem definida, então temos:



Mostremos a implicação $(ii) \implies (i)$:
...
Para mostrar que $Z(G) \leq G$ basta mostrar que:
