...
Note que, como $K\subseteq H$, todo elemento de $G/K$ é evidentemente elemento de $G/H$ e a função é bem definida e sobrejetora.
...
Note que $\operatorname{Aut}(G)$ não é vazio, uma vez que o isomorfismo $e: G\to G, \; e(g) = g$ está em $\operatorname{Aut}(G)$.

Evidentemente a função $e$ é o elemento neutro de $\operatorname{Aut}(G)$.
...
\begin{itemize}
	\item \textit{Note que se $H<G$, então $H\trianglechar G$};
	\item \textit{Um subgrupo característico é considerado mais forte que apenas ser um subgrupo normal, uma vez que enquanto um subgrupo normal é invariante apenas para automorfismos internos, um subgrupo característico é invariante para todo automorfismo de $G$}:
\end{itemize}
