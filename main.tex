...
\begin{theorem}
\color{red}
	Sejam $X$ um conjunto finito tal que $\text{Card}(X) \geq 2$ e munido de uma ordem total e uma permutação $\sigma\in\mathfrak{S}_X$.

Portanto, ao decompor $\sigma = \tau_1\ldots\tau_m$, onde $\tau_i$ é uma transposição, temos que:
