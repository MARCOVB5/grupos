...
\begin{theorem}
\color{red}
Seja $X=\{x_1,\ldots,x_n\}$ para $n\geq 2$. Então toda permutação $\sigma\in\mathfrak{S}_X$ pode ser decomposta em um produto de ciclos de suportes dois a dois disjuntos.
