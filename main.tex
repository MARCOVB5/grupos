...
Suponhamos agora $H \neq \{0\}$. Seja $n = \text{min}\{a \in \mathbb{Z},\; a > 0 \}$. 
...
Porém, pela minimalidade de $n$ deduzimos que $r = 0$.
...
\[
\forall i \in I, \; \forall x \in H_i, \; \exists x^{-1} \in H_i   
\]
...
\begin{definition}
    ...
    Se $\alpha \in G$, \textbf{a ordem de $\alpha$ é a ordem do subgrupo gerado por $\alpha$}, denotada por $\mathcal{O}(\alpha)$, isto é,  $\vert \langle \alpha \rangle \vert$.
\end{definition}
...
\begin{definition}
	... Sobre número de classes laterais em G...
