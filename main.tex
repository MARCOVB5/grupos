...
\begin{enumerate}
    ...
    \item $\forall x \in \bigcap_{i \in I} H_i \exists \; x^{-1} \in \bigcap_{i\in I} H _i$.
\end{enumerate}
...
\[
\forall x \in \bigcap_{i \in I} H_i \iff \forall i \in I, \; x \in H_i
\]
...
\[
\forall i \in I, \; \forall x \in H_i, \; x^{-1} \in H_i   
\]

Mas isso é a mesma coisa que:

\[
\forall x \in \bigcap_{i \in I} H_i, \; x^{-1} \in \bigcap_{i \in I} H_i
\]
